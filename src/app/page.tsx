        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gray-800 backdrop-blur-sm p-8 rounded-lg text-center hover:border-1 hover:border-primary/20 hover:shadow-2xl"
            >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.2 }}
              className="bg-gray-800 p-8 rounded-lg text-center hover:border-1 hover:border-primary/20 hover:shadow-2xl"
            >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.4 }}
              className="bg-gray-800 p-8 rounded-lg text-center hover:bg-gray-800 hover:border-1 hover:border-primary/20 hover:shadow-2xl"
            >
            ...
            <div className="flex items-center justify-between mb-12">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <Badge
                    variant="outline"
                    className="border-primary text-muted"
                  >
                    New
                  </Badge>
                </div>
